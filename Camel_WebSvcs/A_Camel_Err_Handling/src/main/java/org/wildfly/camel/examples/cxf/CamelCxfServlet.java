...
public class CamelCxfServlet extends HttpServlet {
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        ...
        String greeting = producer.requestBody("direct:start", serviceParams, String.class);
        ...
        String date = producer2.requestBody("direct:fetchdate", serviceParams2, String.class);
