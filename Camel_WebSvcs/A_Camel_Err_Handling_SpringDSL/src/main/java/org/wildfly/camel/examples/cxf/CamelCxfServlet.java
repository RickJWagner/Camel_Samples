...
public class CamelCxfServlet extends HttpServlet {
    ...
    @Inject
    @ContextName("cxf-camel-context2")
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        ...
        String greeting = producer.requestBody("direct-vm:start", serviceParams, String.class);

        ProducerTemplate producer2 = camelContext2.createProducerTemplate();
        String shouldThereBeTrouble = "N";  // By default, no trouble
        if ("trouble".equals(name)){
            shouldThereBeTrouble = "Y";
        }
        Object[] serviceParams2 = new Object[] {shouldThereBeTrouble};
        String date = producer2.requestBody("direct-vm:fetchdate", serviceParams2, String.class);

        String result = greeting + " " + date;
